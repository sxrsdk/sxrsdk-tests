...
import com.samsungxr.SXRPostEffectMap;
...
public class CustomPostEffectShaderManager {
    ...
    private SXRCustomPostEffectShaderId mShaderId;
    private SXRPostEffectMap mCustomShader;

    public CustomPostEffectShaderManager(SXRContext sxrContext) {
        final SXRPostEffectShaderManager shaderManager = sxrContext
    ...
    public SXRCustomPostEffectShaderId getShaderId() {
        return mShaderId;
    }
}
