...
public class GamepadButton extends SXRSceneObject {
    ...
    public GamepadButton(SXRContext sxrContext, TypedArray array) {
        ...
        buttonTexture = sxrContext.loadTexture(new SXRAndroidResource(
                sxrContext, R.drawable.gamepad_diffuse));
        
        eventTexture = sxrContext.loadTexture(new SXRAndroidResource(
    ...
    public void showButtonPressed(float angle) {
        ...
        SXRRotationByAxisWithPivotAnimation dpadRotation = new SXRRotationByAxisWithPivotAnimation(buttonHover, 0.001f, angle, 0, 0, 1, pivotX, pivotY, pivotZ);
    ...
    public void handlerButtonStates(boolean pressed) {
        ...
        if(pressed){
            ...
            if(!isDown){
                ...
                SXRRelativeMotionAnimation eventDown = new SXRRelativeMotionAnimation(this, DOWN_SIMPLE_BUTTON_TIME,
            ...
            if(isDown){
                ...
                SXRRelativeMotionAnimation evDown = new SXRRelativeMotionAnimation(this, DOWN_SIMPLE_BUTTON_TIME,
                        this.getTransform().getPositionX(), 
                        this.getTransform().getPositionY(), 
