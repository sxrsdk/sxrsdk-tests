...
public class sixaxisActivity extends SXRActivity implements OnGestureListener, OnDoubleTapListener {


    private enum Parameter{A, B};
    private sixaxisViewManager mViewManager = null;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mViewManager = new sixaxisViewManager();
        setScript(mViewManager, "sxr.xml");
