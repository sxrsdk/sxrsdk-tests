package com.samsungxr.controls_func;
 ...
 */
public class ControlsTest extends ActivityInstrumentationSXRf {
    ...
    public void testGetInstance() {
        ...
        Instrumentation.ActivityMonitor monitor = mInstrumentation.addMonitor(com.samsungxr.viewmanager.controls.Test01MainActivity.class.getName(), null, false);
        // We launch it
        Intent intent = new Intent(Intent.ACTION_MAIN);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setClassName(mInstrumentation.getTargetContext(), com.samsungxr.viewmanager.controls.Test01MainActivity.class.getName());
